...
const i18n = {
    ...
    translations: {
        zh: {
            ...
            syncMode: '同步方式',
            syncModeDb: '本地数据库',
            syncModeWebdav: 'WebDAV 云同步',
            autoSync: '自动同步',
            syncInterval: '同步间隔',
            syncIntervalValue: '{value} 分钟',
            lastSync: '上次同步',
            neverSynced: '从未同步',
            syncStatus: '同步状态',
            syncStatusConnected: '已连接',
            syncStatusDisconnected: '未连接',
            syncStatusSuccess: '同步成功',
            syncStatusFailed: '同步失败',
            syncing: '同步中...',
            restoreFromCloud: '从云端恢复',
            backupToCloud: '备份到云端',
            webdavConnected: 'WebDAV 已连接',
            webdavConnectionFailed: 'WebDAV 连接失败',
            pleaseConfigureWebdav: '请先配置 WebDAV',
        ...
        en: {
            ...
            sync: 'Sync',
            syncMode: 'Sync Mode',
            syncModeDb: 'Local Database',
            syncModeWebdav: 'WebDAV Cloud Sync',
            autoSync: 'Auto Sync',
            syncInterval: 'Sync Interval',
            syncIntervalValue: '{value} minutes',
            lastSync: 'Last Sync',
            neverSynced: 'Never synced',
            syncStatus: 'Sync Status',
            syncStatusConnected: 'Connected',
            ...
            webdavConnected: 'WebDAV Connected',
            webdavConnectionFailed: 'WebDAV Connection Failed',
            pleaseConfigureWebdav: 'Please configure WebDAV first',
